...
static const int user_bh            = 10;       /* bar_height: 2 is the default spacing around the bar's font */
...
static const Key keys[] = {
	...
	{ MODKEY4,                       XK_t,      setlayout,      {.v = &layouts[0]} },
	{ MODKEY4,                       XK_f,      setlayout,      {.v = &layouts[1]} },
